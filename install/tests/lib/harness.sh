...
harness_init() {
  ...
  unset GNSS_BACKEND GNSS_STATUS_SOURCE GNSS_STACK GNSS_RECEIVER_FAMILY \
        GNSS_TRANSPORT GNSS_SERIAL_DEVICE GNSS_SERIAL_BAUD GNSS_FRAME_ID GNSS_DEVICE GNSS_DEVICE_GID \
        ...
        MOWGLI_ROS2_IMAGE UNIVERSAL_GNSS_IMAGE UNIVERSAL_GNSS_LOG_DIR UNIVERSAL_GNSS_EXPORT_DIR MAVROS_IMAGE GUI_IMAGE \
  ...
  GNSS_DEVICE_GID="${GNSS_DEVICE_GID:-20}"
