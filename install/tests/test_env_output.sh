...
if ! harness_run; then
  ...
  assert_contains "Universal GNSS image stays independent from IMAGE_TAG"     "UNIVERSAL_GNSS_IMAGE=ghcr.io/pepeuch/universal-gnss-ros2-lyrical:v0.1.4-rc2" "$feature_env"
