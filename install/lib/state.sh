...
is_allowed_installer_key() {
  ...
  case "$key" in
    ...
    GNSS_BACKEND|GNSS_STATUS_SOURCE|GNSS_STACK|GNSS_RECEIVER_FAMILY|GNSS_TRANSPORT|GNSS_SERIAL_DEVICE|GNSS_SERIAL_BAUD|GNSS_FRAME_ID|GNSS_DEVICE|GNSS_DEVICE_GID|\
    ...
    IMAGE_TAG|\
    MOWGLI_ROS2_IMAGE|UNIVERSAL_GNSS_IMAGE|UNIVERSAL_GNSS_LOG_DIR|UNIVERSAL_GNSS_EXPORT_DIR|LIDAR_IMAGE|MAVROS_IMAGE|GUI_IMAGE|\
