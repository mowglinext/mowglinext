...
assert_contains "help explains first-boot receiver family default" "Universal GNSS receiver family first-boot default: auto, ublox, unicore, nmea" "$help_output"
assert_contains "help explains first-boot serial link default" "Universal GNSS serial link first-boot default: usb or uart" "$help_output"
